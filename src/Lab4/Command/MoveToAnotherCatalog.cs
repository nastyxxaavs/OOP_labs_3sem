...
public class MoveToAnotherCatalog : ICommand
{
    private string _destinationPath;
    private ILocalServices _receiver;
    private string _path;

    public MoveToAnotherCatalog(ILocalServices receiver, string path, string destinationPath)
    {
        _receiver = receiver;
        _path = path;
    ...
    public void Execute()
    {
        ...
        if (CorrectArguments(arguments)) _receiver.MoveToAnotherCatalog(_path, _destinationPath);
    }
