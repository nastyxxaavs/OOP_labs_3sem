...
public static class CorrectDetails
{
    ...
    {
        ICollection<Condition> condition = new List<Condition>();
        if (pc is not null && pc.RAM is not null && pc.Motherboard is not null && pc.RAM.DdrVersion is not null && pc.Motherboard.Ddr is not null)
        {
    ...
    public static ICollection<Condition> CorrectBuilding(PC? pc)
    {
        ICollection<Condition> condition = new List<Condition>();
        if (pc is not null)
        {
